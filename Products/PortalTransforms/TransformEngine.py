        ...
        while len(typesToStartFrom) > 0:
            for startingType in typesToStartFrom:
                ...
                if outputs:
                    ...
                    # We explored all types this starting type can lead
                    # to in one single step. Let's remove this type from
                    # the list of types to start from.
                    typesToStartFrom.remove(startingType)
